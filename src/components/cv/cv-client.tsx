  ...
  return (
    <div className="rounded-3xl border border-white/60 bg-white p-8 shadow-xl">
      ...
      <div className="mt-6 space-y-3 text-sm">
        <ContactRow label="Email" href={`mailto:${personalInfo.email}`} value={personalInfo.email} />
        <ContactRow label="Location" value={personalInfo.city} />
        <ContactRow label="GitHub" href={personalInfo.githubUrl} value={personalInfo.githubUrl.replace(/^https?:\/\//, "")} />
        <ContactRow label="LinkedIn" href={personalInfo.linkedinUrl} value={personalInfo.linkedinUrl.replace(/^https?:\/\//, "")} />
        {personalInfo.websiteUrl ? (
          <ContactRow label="Website" href={personalInfo.websiteUrl} value={personalInfo.websiteUrl.replace(/^https?:\/\//, "")} />
        ) : null}
      </div>
    </div>
  );
...
function ProjectDrawer({ project, onClose }: { project?: CvProject; onClose: () => void }) {
        ...
        {project ? (
          <div className="space-y-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-[var(--muted)]">Project</p>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[var(--foreground)]">Tech stack</h3>
            ...
            {project.images.length ? (
              <div className="space-y-3">
                <h3 className="text-sm font-semibold text-[var(--foreground)]">Gallery</h3>
